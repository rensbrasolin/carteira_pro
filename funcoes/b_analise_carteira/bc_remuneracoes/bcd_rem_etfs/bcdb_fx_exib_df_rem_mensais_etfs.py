...
def _exibir_df_rem_mensais_etfs(df_rem_mensais_etfs):

    df_rem_mensais_etfs_exib = df_rem_mensais_etfs.copy()

    # Excluindo cols desnecessárias na hora certa.
    df_rem_mensais_etfs_exib = df_rem_mensais_etfs_exib.drop(
        columns=[('', 'Tipo')])
