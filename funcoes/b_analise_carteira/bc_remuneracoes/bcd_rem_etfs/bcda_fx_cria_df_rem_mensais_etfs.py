...
def _iniciar_df_rem_mensais_etfs(df_rem_mensais):
    
    df_rem_mensais_etfs = df_rem_mensais.copy()

    # Mantendo apenas linhas de ações.
    df_rem_mensais_etfs = df_rem_mensais_etfs.loc[
    df_rem_mensais_etfs[('', 'Tipo')] == 'ETF']
...
# --------------------------------------------------------------------------------------------------------------------- FX principal que cria o df_rem_mensais_etfs
def criar_df_rem_mensais_etfs(df_rem_mensais):

    df_rem_mensais_etfs = _iniciar_df_rem_mensais_etfs(df_rem_mensais=df_rem_mensais)
